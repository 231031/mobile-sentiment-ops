...
def parse_args():
    ...
    p.add_argument("--data_path", required=True, help="Path to CSV with 'review_text' and 'sentiment' columns")
    p.add_argument("--experiment_name", default="Sentiment LR", help="MLflow experiment name")
    p.add_argument("--registered_model_name", default="sentiment-logreg", help="MLflow registered model name")
    ...
    p.add_argument("--max_features", type=int, default=300, help="TF-IDF max_features")
    return p.parse_args()
